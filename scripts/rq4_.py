...
from setup_data_ import load_annotation_data
...
def main() -> None:
    ...
    COL_GAZE = COL.GAZE
    COL_SPEECH = COL.SPEECH
    COL_MOTOR = COL.MOTOR
    COL_OTHER_BEHAVIOURAL = COL.OTHER_BEHAVIORAL
    COL_OTHER_DATA = COL.OTHER_DATA
    COL_FUSION_TECHNIQUE = COL.FEATURE_FUSION
    COL_ALGORITHMS = COL.ALGORITHMS
    COL_FEATURES = COL.FEATURES
    COL_LEARNING_TYPE = COL.LEARNING_TYPE
    COL_EVALUATION_METRICS = COL.EVALUATION_METRICS
    COL_BEST_MODEL = COL.BEST_MODEL
    COL_BEST_PERFORMANCE = COL.BEST_PERFORMANCE
    COL_FEATURE_IMPORTANCE_TECHNIQUE = COL.FEATURE_IMPORTANCE_TECHNIQUE
    COL_FEATURE_IMPORTANCE_RESULT = COL.FEATURE_IMPORTANCE_RESULT
    COL_BALANCING_TECHNIQUE = COL.BALANCING_TECHNIQUE
    COL_CROSS_CORPUS_VALIDATION = COL.CROSS_CORPUS_VALIDATION
    COL_XFOLD_CV = COL.XFOLD_CV
    COL_LOXO = COL.LOXO
    COL_REAL_TIME_ANALYSIS = COL.REAL_TIME_ANALYSIS
    COL_STUDY_SETTING = COL.STUDY_SETTING
    COL_STUDY_GOAL = COL.STUDY_GOAL
    COL_TASK_PARTICIPANTS = COL.PARTICIPANT_TASK
    ...
    def features_broad(col, valid_mask):
        patterns = {
            ...
            "motor_pose_kinematic_features": (
                ...
                r"|keypoint|\bpose\b|grip force|sway|jerk|kinematic|gait|stride|walking|gesture|tablet|touch|wheel rotation|rmse"
            ),
    ...
    def feature_subcategories(col, valid_mask):
        ...
        parent_patterns = {
            ...
            "language_speech_acoustic": (
                ...
                r"|\btext embedding\b|tweet|questionnaire|q[- ]?chat|audio|raw audio|spectrogram|spectral|mfcc|timbre|prosody|pitch"
        ...
        subcategory_patterns = {
            ...
            "pose_skeletal_features": {"parent": "motor_pose_kinematic", "pattern": r"openpose|open pose|open-pose|skeletal keypoint|skeletal keypoints|skeleton|keypoint|joint movement|\bpose\b"},
            ...
            "text_embedding_nlp_features": {"parent": "language_speech_acoustic", "pattern": r"\bnlp\b|natural language processing|universal sentence encoder|\buse\b|word2vec|wav2vec|bert|transformer|\btext embedding\b|language embedding|sentence embedding"},
    ...
    def compute_feature_importance_result(col, valid_mask):
        ...
        patterns = {
            ...
            "speech_and_acoustic_features": r"speech|acoustic|voice|vocal|prosody|pitch|fundamental frequency|\bf0\b|mfcc|rasta|mcep|hmpdm|hmpdd|rhythm|harmony-to-noise|hnr|sentiment|emotional|liwc|\btext feature\b|\bword\b|embedding",
