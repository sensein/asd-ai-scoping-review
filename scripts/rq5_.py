...
from analysis_common import (
    RQ_QUESTIONS,
    RQ_TITLES,
    YEAR_GROUP_ORDER as SHARED_YEAR_GROUP_ORDER,
    classify_year_group as shared_classify_year_group,
    extract_publication_year as shared_extract_publication_year,
)
from setup_data_ import load_annotation_data, INVALID_VALUES
from helper_functions_ import (
    AGE_CATEGORY_COLS,
    compute_asd_age_ranges,
    compute_behavioral_modality_by_year,
    compute_task_type,
    ensure_series_mask,
    save_df_optional,
    TASK_TYPE_COLS,
...
def main() -> None:
    ...
    COL_TITLE = COL.TITLE
    COL_KEYWORDS = COL.KEYWORDS
    COL_JOURNAL = COL.JOURNAL
    ...
    COL_MOTOR = COL.MOTOR
    COL_OTHER_BEHAVIORAL = COL.OTHER_BEHAVIORAL
    COL_OTHER_TYPE_DATA = COL.OTHER_DATA
    COL_FEATURE_FUSION = COL.FEATURE_FUSION
    ...
    def extract_publication_year(value):
        return shared_extract_publication_year(value)


    def classify_year_group(year):
        return shared_classify_year_group(year)


    YEAR_GROUP_ORDER = SHARED_YEAR_GROUP_ORDER
    ...
    # ============================================================
    # 9. BEHAVIORAL MODALITY BY PUBLICATION YEAR GROUP
    # ============================================================

    (
        behavioral_modality_by_year_summary,
        valid_papers_by_year_group,
        behavioral_modality_year_match_table,
    ) = compute_behavioral_modality_by_year(
        data_df=df_subset,
    ...
    print("- behavioral_modality_by_year_summary.csv")
